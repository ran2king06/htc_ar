  ...
  return (
    <section className="tour-content">
      ...
      <div className="tour-content-store">
        ...
        <p>
          XR 數位百老匯劇院(VIVELAND)，體驗全球首創的可移動式 5G XR 劇場，延伸自熱門的永恆聖母院和巴黎舞會 VR 體驗，使用 VIVE Focus 3 一體機和實景娛樂技術，提供多人同步的沉浸式互動體驗。遊客可在高雄棧柒庫園區內和戶外 5G 展示場地，盡情探索虛擬現實中的精彩內容。透過 5G 高傳輸速率及低延遲，享受流暢的視角轉換和高品質影像，無論是遊戲、劇場還是數位展演，都能在這裡找到最新鮮的數位內容體驗！
        </p>
